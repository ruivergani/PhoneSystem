...
Module Module2
    ...
    Sub AddCustomer()
        ...
        Do
            ...
            Else
                trueval = True
                vetorCustomer(position).id = tempid
            End If
    ...
    Sub EnterMobileUsage()
        ...
        Dim tempid, i, num1, index As Integer
        Dim found As Boolean = False
        ...
        If found = True Then
            ...
            Do
                ...
                tempstr = StrConv(Console.ReadLine, VbStrConv.ProperCase)
                ' vetorCustomer(index).statement(num1).planType = StrConv(Console.ReadLine, VbStrConv.ProperCase)

                tempString = tempstr.ToUpper
                If ((tempString = "3G") Or (tempString = "4G") Or (tempString = "5G")) Then
                    trueval = True
                    vetorCustomer(index).statement(num1).planType = tempstr
                Else
                    trueval = False
                    Console.ForegroundColor = ConsoleColor.Red
                    Console.WriteLine("Invalid Plan Type.")
                    Console.ForegroundColor = ConsoleColor.Gray
                End If
